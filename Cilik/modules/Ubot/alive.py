...
modules = CMD_HELP
alive_logo = (
    gvarstatus("ALIVE_LOGO") or "https://telegra.ph//file/477aeb3520a27723f9f0d.jpg"
)
emoji = gvarstatus("ALIVE_EMOJI") or "⚡"
alive_text = gvarstatus("ALIVE_TEKS_CUSTOM") or "Hey, I am alive."


@Client.on_message(filters.command(["alive", "iyan"], [".", "-", "^", "!", "?"]) & filters.me)
async def alive(client: Client, message: Message):
    ...
    man = (
        ...
        f"{emoji} <b>Support :</b> [Iyan Store](https://t.me/SherleanShop)"
    )
    try:
